...
The analysis draws on revenue trends, efficiency ratios, balance sheet health, and systemic risk exposure to conclude that **Nvidia’s valuation may, or not, be supported by fundamentals**, placing it at risk of being within a financial bubble.
...
---
### **I. Business Growth**  
##### I.1. Revenue Compound Annual Growth Rate between 2019 & 2025
...
The corporation's revenue CAGR between 2019 and 2025 is **41.11 %**. As is, it reveals a very strong growth over a period of 7 years. For comparison, for the same period, it is almost _2.5 times that of Nasdaq-100_ and only _10 points lower than Bitcoin's_ one. 


The only problem with this metric is that it doesn't tell us more than that so we need to look more specifically into Nvidia's balancesheets to see if this CAGR is stable through the period or, if only a part of it is responsible for its elevated value.
...
We can see from this plot that the high revenue CAGR's originates from the end of the period, more acurately in 2024 and 2025, thus positively biasing its value. 

On the subplot on the right, we can see that there is a strong correlation between the total revenue's variations and its respective top two segments. <br \>
In 2023, the same relationship shifts between the whole and a unique segment only, implying a stronger concentration risk. 


##### I.2. Segment concentration risk:


Though we can already tell from the plot in the previous section which of Nvidia's segments is the most important, we will specifically look closer by using quarterly revenue data per segment, it's also to get a more accurate understanding of the hinted existing concentration risk.
...
Until the second quarter of 2024, the second most important segment of the company was the **Data Center** one before it later reached the first place as their GPUs took a strategic position in the Artificial Intelligence sector. <br />
In 2025, from plot II-b, we see that 88.3 % of their total revenue is dependant on this lattest green colored segment, while Gaming, now, only accounts for 8.7 % of it.

That's why we can affirm that today's revenue of Nvidia is highly concentrated and dependant on the AI sector's evolution. 
...
##### II.1. Traditional profitability ratios:
This first calculation will help us to measure how efficiently Nvidia turns revenue increases into operating income.
...
This next one captures profitability before interest and taxes.
...
Though Nvidia's operating margins mainly increased during our selected timeline, nearly doubling, it is mostly due to increasing total revenue more than decreasing operating expenses.
...
##### II.2. Cost structure dynamics over time:
...
From the revenue structure of the two periods, we see that net income has substantially increased, from 27.2 % in average, between 2019 & 2023 to 45.0 % in 2024-2025, or, a positive difference of 17.8 points between periods.
This is explained by the improvement of the internal costs components of the revenue though the external ones deteriorated (Taxes and interests): COGS went from 38.7 % to 30.0 % (an -8.7 points difference) and OpEx from 34.0 % to 20.9 % (-13.1 points) while Taxes and interests rose from less than 0.1 % to 4.2 % (+4.1 points); we get: 17.8 % =~ 8.7 + 13.1 - 4.1


Though these results could be seen as promising, we have to keep in mind that they are on percentages, therefore incomplete to solely interpret by themselves. If we keep in mind the growth difference in revenue and compare it to the improvement of the cost structure for the same periods, the later almost loses all of its appeal. 
...
However, in 2024, the situation got inverted as EV and MC growth percentages were 3 times lower than the net income's one.
